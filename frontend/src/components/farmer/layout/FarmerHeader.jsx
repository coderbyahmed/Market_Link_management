...
import FarmerProfileMenu from "../profile/FarmerProfileMenu.jsx";
import FarmerNotificationBell from "../notifications/FarmerNotificationBell.jsx";
...
const FarmerHeader = ({ onToggleSidebar, theme, onToggleTheme }) => {
  return (
