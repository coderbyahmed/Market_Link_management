...
import { FaUser, FaEnvelope, FaPhoneAlt, FaSeedling, FaUserCheck } from "react-icons/fa";
import { showSuccess, showError } from "../../common/feedback/MessageProvider.jsx";
import Button from "../../common/Button.jsx";

const FarmerProfileInfo = ({ profile, open, onOpen, onClose, onSave }) => {
  ...
  const rows = [
    ...
    { label: "Farm Specialization", value: profile.farmSpecialization, icon: FaSeedling },
