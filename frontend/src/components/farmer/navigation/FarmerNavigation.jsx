...
const navItems = [
  { label: "Dashboard", to: "/farmer/dashboard", icon: FaThLarge },
  {
    label: "Products",
    icon: FaBox,
    children: [
      { label: "All Products", to: "/farmer/products" },
      { label: "Add Product", to: "/farmer/products/add" },
      { label: "Product Requests", to: "/farmer/products/requests" },
      { label: "Weekly Stock", to: "/farmer/products/weekly-stock" },
    ],
  },
  { label: "Orders", to: "/farmer/orders", icon: FaClipboardList },
  { label: "Crop Listings", to: "/farmer/crop-listings", icon: FaSeedling },
  { label: "Reviews", to: "/farmer/reviews", icon: FaStar },
  { label: "Reports", to: "/farmer/reports", icon: FaChartBar },
  { label: "Settings", to: "/farmer/settings", icon: FaCog },
];
...
const FarmerNavigation = ({ collapsed = false, onNavigate = () => {} }) => {
