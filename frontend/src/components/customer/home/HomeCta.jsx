  ...
  return (
    <section className="bg-white py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-900 via-brand-800 to-brand-600 px-6 py-14 text-center sm:px-12 lg:py-18">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-brand-100/90 sm:text-lg">
              Explore the full marketplace and fill your basket with the
              season’s best from farmers near you.
            </p>
