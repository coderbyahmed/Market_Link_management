...
const AdminLayout = ({ children }) => {
  ...
  const [theme, setTheme] = useState(
    () => localStorage.getItem("ml-admin-theme") || "light"
  );

  useEffect(() => {
    localStorage.setItem("ml-admin-theme", theme);
  }, [theme]);
  ...
  return (
    <div className={`min-h-screen ${theme === "dark" ? "dark" : ""} bg-stone-100 dark:bg-stone-950 lg:flex`}>
